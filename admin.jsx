  ...
  return (
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <button onClick={() => setActiveTab("new")}>Add Prompt</button>
        <button onClick={() => setActiveTab("prompts")}>My Prompts</button>
        <button onClick={() => setActiveTab("settings")}>Settings</button>
        <a href="/" className="back-home">رجوع للموقع</a>
      </aside>
        ...
        {activeTab === "new" && (
          <div>
            ...
            <div className="preview-card">
              ...
              <p>{form.prompt || "هنا يظهر نص البرومبت"}</p>
        ...
        {activeTab === "settings" && (
          <div>
            ...
            <div className="settings-box">
              <p>هذه لوحة إدارة محلية كبداية.</p>
              <p>الخطوة الجاية نربطها بقاعدة بيانات وتحديث مباشر للموقع.</p>
            </div>
          </div>
        )}
      </main>
